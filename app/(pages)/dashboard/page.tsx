...
const socialLinks = [
  {
    label: "Facebook",
    url: "https://facebook.com/richasharma",
    icon: (
  ...
  {
    label: "Instagram",
    url: "https://instagram.com/richasharma",
    icon: (
      <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "LinkedIn",
    url: "https://linkedin.com/in/richasharma",
    icon: (
      <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    label: "YouTube",
    url: "https://youtube.com/@richasharma",
    icon: (
      <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div className="flex flex-wrap justify-center gap-6 sm:gap-8 md:gap-10 items-center">
          {socialLinks.map((item) => (
            <a
              ...
              className="w-12 h-12 rounded-full flex items-center justify-center bg-gray-200 dark:bg-gray-700 shadow hover:scale-110 transition text-gray-600 dark:text-gray-200 hover:bg-gray-300 dark:hover:bg-gray-600"
              title={item.label}
            >
              {item.icon}
            </a>
