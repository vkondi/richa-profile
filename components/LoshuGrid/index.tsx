...
export const LoshuGrid: React.FC<LoshuGridProps> = ({ grid }) => {
    ...
    return (
      <div 
        ...
        className={`relative flex flex-col items-center justify-center p-4 border ${
          hasNumber ? 'bg-blue-50 border-blue-200' : 'bg-gray-50 border-gray-200'
        }`}
      >
        <div className="absolute top-1 left-1 text-xs text-gray-500">{position}</div>
        {hasNumber && (
